...
COPY ./branding/logo_2x.png /web-vault/images/logo-dark@2x.png
COPY ./branding/logo_2x.png /web-vault/images/logo-light@2x.png
COPY ./branding/logo_2x.png /web-vault/images/logo-white@2x.png
COPY ./branding/logo_1x.png /web-vault/images/logo.png
COPY ./branding/logo_1x.png /web-vault/images/logo-dark.png
COPY ./branding/logo_1x.png /web-vault/images/logo-white.png
